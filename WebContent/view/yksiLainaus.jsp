...
<body>
	<form action="NiteenLainausOhjelma" method="get">
		...
		<div>
			...
			<br />
			<c:out value="${lainaus.lainaaja.osoite}" />
			<br />
		...
		<table>
			...
			<c:forEach items="${lainaus.lista}" var="niteenlainaus">
				<tr>
					<td><c:out value="${niteenlainaus.nide.kirja.isbn}" /></td>
					<td>&nbsp&nbsp&nbsp<c:out
							value="${niteenlainaus.nide.nidenro}" />
					</td>
					<td><c:out value="${niteenlainaus.nide.kirja.nimi}" /></td>
					<td><c:out value="${niteenlainaus.nide.kirja.kirjoittaja}" />
					</td>
					<td>&nbsp&nbsp&nbsp<c:out
							value="${niteenlainaus.nide.kirja.painos}" />
					</td>
					<td><c:out value="${niteenlainaus.nide.kirja.kustantaja}" /></td>
